...
|------|------|
| PubMed EDAT 命中 | **133** |
| PubMed PDAT 同窗（对照） | **40** |
| 临床向标题过滤 | **70** |
| Crossref 去重（标题关键词过滤） | **113** |
| ClinicalTrials.gov 条件相关且 LastUpdate∈近 24h | **25** |
...
| PMID 42505112 | 早期戒酒 LT 评估 n=545；中位戒酒 79 天 |
...
完整 **25** 条见 `raw_clinicaltrials.json`。以下挑与 **HCC / 肝切除 / 胆道 / 肝移植路径** 更直接者：
...
5. 本小时 EDAT 133 vs PDAT 40：说明大量“可见新增”是索引/录入事件，而非全部当日正式发表。
